...
- **18/09/2026 10:52:** Hoàn thiện module tiện ích [zalo.js](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/client/src/utils/zalo.js) và tích hợp nút "Gửi Zalo" 1-chạm trực tiếp trên [DashboardPage.jsx](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/client/src/pages/DashboardPage.jsx) và [InvoiceDetailPage.jsx](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/client/src/pages/InvoiceDetailPage.jsx). Kiểm thử bản dựng Vite React thành công 100%.
- **18/09/2026 11:05:** Triển khai quy trình kiểm thử toàn diện theo skill `@testing-qa`. Xây dựng bộ test tự động [qa_system.test.mjs](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/server/test/qa_system.test.mjs) bao phủ 8 giai đoạn (20 test cases): Health check, Auth/JWT, Quản lý phòng, Chốt số & kiểm tra âm số, Tra cứu token công khai, Khiếu nại/Điều chỉnh 2 chiều, Khóa sổ thanh toán, Báo cáo thống kê Dashboard. Kết quả: 20/20 test cases vượt qua (Pass 100%).
- **18/09/2026 11:07:** Sửa lỗi trắng màn hình trên trang [InvoiceDetailPage.jsx](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/client/src/pages/InvoiceDetailPage.jsx). Nguyên nhân: biến `zaloStatus` và hàm cập nhật `setZaloStatus` chưa được khởi tạo trong `useState`, dẫn đến lỗi `ReferenceError: zaloStatus is not defined` làm sập React Component tree khi tải hóa đơn. Sau khi khai báo state đầy đủ, trang chi tiết hóa đơn hiển thị ổn định, các chức năng tra cứu, đối soát, gửi Zalo và duyệt thanh toán hoạt động trơn tru.
- **18/09/2026 11:17:** Hoàn thành module Tự Động Gửi Hóa Đơn Qua Zalo Cá Nhân (Miễn Phí 100%): Tích hợp thư viện `zca-js` và `qrcode`; Mở rộng `User` model lưu `zaloSession` và `Invoice` model lưu `zaloDelivery`; Xây dựng [zaloPersonalService.js](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/server/services/zaloPersonalService.js), [zaloController.js](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/server/controllers/zaloController.js), [zaloRoutes.js](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/server/routes/zaloRoutes.js); Tự động kích hoạt gửi hóa đơn kèm mã VietQR trong `createInvoice` và bổ sung API `POST /api/invoices/:id/resend-zalo`; Tích hợp giao diện quét mã QR Zalo tại [SettingsPage.jsx](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/client/src/pages/SettingsPage.jsx) và huy hiệu trạng thái giao nhận Zalo tại [InvoiceDetailPage.jsx](file:///c:/Users/ngohi/OneDrive/Documents/PhongTro/client/src/pages/InvoiceDetailPage.jsx). Kiểm thử tự động đạt 24/24 test cases (Pass 100%).
